...
if __name__ == "__main__":
    ...
    args.save = os.path.join(args.cl_exp_dir, args.dataset, args.save)
    ...
    if not args.cl_model_name == "":
        args.input_model_file = os.path.join('./pretrain_models/zinc', args.cl_model_name)
    ...
    if not args.cl_model_name == "":
        ...
        result_name = 'no_pretrain_result.txt'
